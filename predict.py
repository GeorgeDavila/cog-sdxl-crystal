...
class Predictor(BasePredictor):
    def load_trained_weights(self, weights_url, pipe):
        ...
        if not self.is_lora:
            ...
            tensors = load_file(os.path.join(local_weights_cache, LORA_PATH))
    ...
    def predict(
        ...
        if lora == True :
            ...
            self.load_trained_weights(LORA_PATH, self.txt2img_pipe)
        ...
        image = False #disable img inputs for now
        mask = False
        if image and mask:
